(function() {
    ...
    function ba(a, b) {
        ...
        if (c) {
            var d,
                e = c.length,
                f = -1;
            while (++f < e) b((d = ba(c[f], b)), a) > 0 && (a = d);
        }
        return a;
    }
    function _(a) {
        return a.children ? a.children[a.children.length - 1] : a._tree.thread;
    }
    function $(a) {
        return a.children ? a.children[0] : a._tree.thread;
    }
    function Z(a, b) {
    ...
    function U(a, b, c) {
        var d = b.r + c.r,
            ...
            k = i * e,
            l = Math.sin(j) * e;
        (f /= h), (g /= h), (c.x = a.x + k * f + l * g), (c.y = a.y + k * g - l * f);
    }
    function T(a, b, c, d) {
        var e = a.children;
        ...
        if (e) {
            var f = -1,
                g = e.length;
            while (++f < g) T(e[f], b, c, d);
        }
    }
    function S(a) {
        var b = a.children;
        b ? (b.forEach(S), (a.r = P(b))) : (a.r = Math.sqrt(a.value));
    }
    function R(a) {
    ...
    function P(a) {
        ...
        var b = Infinity,
            ...
            j,
            k;
        a.forEach(Q), (g = a[0]), (g.x = -g.r), (g.y = 0), l(g);
        if (f > 1) {
            (h = a[1]), (h.x = h.r), (h.y = 0), l(h);
            if (f > 2) {
                (i = a[2]), U(g, h, i), l(i), M(g, i), (g._pack_prev = i), M(i, h), (h = g._pack_next);
                for (var m = 3; m < f; m++) {
                    U(g, h, (i = a[m]));
                    var n = 0,
                        o = 1,
                    ...
                    n == 0 ? (M(g, i), (h = i), l(i)) : n > 0 ? (N(g, j), (h = j), m--) : (N(j, h), (g = j), m--);
                }
            }
        }
        var q = (b + c) / 2,
    ...
    function F(a, b) {
        (a.sort = d3.rebind(a, b.sort)),
            (a.children = d3.rebind(a, b.children)),
            (a.links = J),
            (a.value = d3.rebind(a, b.value)),
            (a.nodes = function(b) {
                K = !0;
                return (a.nodes = a)(b);
            });
    ...
    function r(a) {
        ...
        if (!a.leaf) {
            ...
            while (++f < e) {
                g = d[f];
                if (g == null) continue;
                r(g), (a.count += g.count), (b += g.count * g.cx), (c += g.count * g.cy);
            }
        }
        a.point &&
    ...
    function o() {
        !f || (g && ((i = !0), q()), d3.event.type === 'mouseup' && n(), (f.fixed = !1), (e = h = f = j = null));
    }
    function n() {
        if (!!f) {
            var a = j.parentNode;
            if (!a) {
                (f.fixed = !1), (h = f = j = null);
                return;
            }
            var b = m(a);
            (g = !0), (f.px = b[0] - h[0]), (f.py = b[1] - h[1]), q(), e.resume();
        }
    }
    function m(a) {
    ...
    (d3.layout = {}),
        ...
        (d3.layout.chord = function() {
            function k() {
                b.sort(function(a, b) {
                    return i(a.target.value, b.target.value);
                });
            }
            function j() {
                var a = {},
                ...
                while (++q < e) {
                    ...
                    while (++r < e) {
                        var v = a[q + '-' + r],
                            w = a[r + '-' + q];
                        (v.value || w.value) &&
                            b.push(v.value < w.value ? { source: w, target: v } : { source: v, target: w });
                    }
                }
                i && k();
            }
        ...
        (d3.layout.force = function() {
            function G(b, c) {
                var d = m(this.parentNode);
                ((f = b).fixed = !0), (g = !1), (j = this), (e = a), (h = [d[0] - b.x, d[1] - b.y]), q();
            }
            function F() {
                var a = A.length,
                    e = B.length,
                    f = d3.geom.quadtree(A),
                    g,
                    h,
                    j,
                    k,
                    ...
                    n;
                for (g = 0; g < e; ++g) {
                    (h = B[g]), (j = h.source), (k = h.target), (m = k.x - j.x), (n = k.y - j.y);
                    if ((l = m * m + n * n))
                        (l = (d * D[g] * ((l = Math.sqrt(l)) - C[g])) / l),
                            (m *= l),
                            (n *= l),
                            (k.x -= m),
                            (k.y -= n),
                ...
                var o = d * x;
                (m = c[0] / 2), (n = c[1] / 2), (g = -1);
                while (++g < a) (h = A[g]), (h.x += (m - h.x) * o), (h.y += (n - h.y) * o);
                r(f);
                var p = d * w;
                g = -1;
                while (++g < a) f.visit(E(A[g], p));
                g = -1;
                while (++g < a)
                    (h = A[g]),
                        h.fixed
                            ? ((h.x = h.px), (h.y = h.py))
                            : ((h.x -= (h.px - (h.px = h.x)) * i), (h.y -= (h.py - (h.py = h.y)) * i));
                b.tick.dispatch({ type: 'tick', alpha: d });
                return (d *= 0.99) < 0.005;
            }
            function E(a, b) {
                return function(c, d, e, f, g) {
                    if (c.point !== a) {
                        var h = c.cx - a.x,
                            i = c.cy - a.y,
                            j = 1 / Math.sqrt(h * h + i * i);
                        if ((f - d) * j < y) {
                            var k = b * c.count * j * j;
                            (a.x += h * k), (a.y += i * k);
                            return !0;
                        }
                        if (c.point && isFinite(j)) {
                            var k = b * j * j;
                            (a.x += h * k), (a.y += i * k);
                        }
                    }
            ...
            (a.on = function(c, d) {
                ...
                (a.start = function() {
                    ...
                    var b,
                        ...
                        i,
                        j;
                    for (b = 0; b < e; ++b) (j = A[b]).index = b;
                    (C = []), (D = []);
                    for (b = 0; b < f; ++b)
                        (j = B[b]),
                            typeof j.source == 'number' && (j.source = A[j.source]),
                            typeof j.target == 'number' && (j.target = A[j.target]),
                            (C[b] = u.call(this, j, b)),
                            (D[b] = v.call(this, j, b));
                    for (b = 0; b < e; ++b)
                        (j = A[b]),
                ...
                (a.drag = function() {
                    this.on('mouseover.force', k)
                        .on('mouseout.force', l)
                        .on('mousedown.force', G)
                        .on('touchstart.force', G),
                        d3
                            .select(window)
                            .on('mousemove.force', n)
                            .on('touchmove.force', n)
                            .on('mouseup.force', o, !0)
                            .on('touchend.force', o, !0)
                            .on('click.force', p, !0);
                    return a;
                });
            return a;
    ...
    (d3.layout.partition = function() {
        ...
        (d3.layout.pie = function() {
            function f(f, g) {
                var h = +(typeof c == 'function' ? c.apply(this, arguments) : c),
                    i = (typeof e == 'function' ? e.apply(this, arguments) : e) - c,
                    j = d3.range(f.length);
                b != null &&
                    j.sort(function(a, c) {
                        return b(f[a], f[c]);
        ...
        (d3.layout.stack = function() {
            ...
            (g.values = function(b) {
                ...
                (g.order = function(a) {
                    if (!arguments.length) return b;
                    b = typeof a == 'function' ? a : x[a];
                    return g;
                }),
                (g.offset = function(a) {
                    if (!arguments.length) return c;
                    c = typeof a == 'function' ? a : y[a];
                    return g;
                }),
                (g.x = function(a) {
                    if (!arguments.length) return e;
    ...
    (d3.layout.histogram = function() {
        function e(e, f) {
            ...
            f = -1;
            while (++f < l)
                (o = h[f]), o >= i[0] && o <= i[1] && ((k = g[d3.bisect(j, o, 1, m) - 1]), (k.y += n), k.push(e[f]));
            return g;
        }
        var a = !0,
            b = Number,
            ...
            function f(a, b) {
                ...
                if (d) {
                    var h = -1,
                        ...
                        j = b + 1;
                    while (++h < i) e += f(d[h], j);
                } else c && (e = c.call(g, K ? a : a.data, b));
                c && (a.value = e);
                return e;
            }
            function e(f, h, i) {
    ...
    (d3.layout.pack = function() {
        ...
        var a = d3.layout.hierarchy().sort(L),
            b = [1, 1];
        c.size = function(a) {
            if (!arguments.length) return b;
            b = a;
        ...
        (d3.layout.cluster = function() {
            function d(d, e) {
                ...
                be(g, function(a) {
                    a.children
                        ? ((a.x = W(a.children)), (a.y = V(a.children)))
                    ...
                    if (c) {
                        ...
                        while (((g = _(g)), (e = $(e)), g && e))
                            (h = $(h)),
                                ...
                                m > 0 && (bg(bh(g, a, d), a, m), (i += m), (j += m)),
                                (k += g._tree.mod),
                                (i += e._tree.mod),
                                (l += h._tree.mod),
                                (j += f._tree.mod);
                        g && !_(f) && ((f._tree.thread = g), (f._tree.mod += k - j)),
                            e && !$(h) && ((h._tree.thread = e), (h._tree.mod += i - l), (d = a));
                    }
                    return d;
                }
                function i(a, b) {
        ...
        (d3.layout.treemap = function() {
            ...
            function k(a, c, d, e) {
                ...
                if (c == d.dx) {
                    if (e || j > d.dy) j = d.dy;
                    while (++f < g) (k = a[f]), (k.x = h), (k.y = i), (k.dy = j), (h += k.dx = b(k.area / j));
                    (k.z = !0), (k.dx += d.x + d.dx - h), (d.y += j), (d.dy -= j);
                } else {
                    if (e || j > d.dx) j = d.dx;
                    while (++f < g) (k = a[f]), (k.x = h), (k.y = i), (k.dx = j), (i += k.dy = b(k.area / j));
            ...
            function j(a, b) {
                var c = a.area,
                    ...
                    h = -1,
                    i = a.length;
                while (++h < i) (d = a[h].area), d < g && (g = d), d > e && (e = d);
                (c *= c), (b *= b);
                return g || e ? Math.max((b * e * f) / c, c / (b * g * f)) : Infinity;
            }
            function i(a) {
                if (!!a.children) {
                    var b = { x: a.x, y: a.y, dx: a.dx, dy: a.dy },
                        c = a.children.slice(),
                        d,
                        e = [];
                    e.area = 0;
                    while ((d = c.pop()))
                        e.push(d),
                            (e.area += d.area),
                            d.z != null && (k(e, d.z ? b.dx : b.dy, b, !c.length), (e.length = e.area = 0));
                        ...
                        c.push((e = d[l - 1])),
                            ...
                            (g = j(c, i)) <= f
                                ...
                                : ((c.area -= c.pop().area),
                                  ...
                                  (c.length = c.area = 0),
                                  (f = Infinity));
                    c.length && (k(c, i, b, !0), (c.length = c.area = 0)), a.children.forEach(h);
                }
            }
            function g(a, b) {
                var c = a.children,
                    d = a.value;
                a.area = isNaN(d) || d < 0 ? 0 : d * b;
                if (c) {
                    var e = -1,
                        f = c.length;
                    while (++e < f) g(c[e], b);
            ...
            (l.size = function(a) {
                ...
                (l.round = function(a) {
                    if (!arguments.length) return b != Number;
                    b = a ? Math.round : Number;
                    return l;
                }),
                (l.sticky = function(a) {
                    if (!arguments.length) return d;
