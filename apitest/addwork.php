  ...
  if(isset($data["REF_NO"]) && isset($data["PROJECTNAME"]) && isset($data["STATUS"]) &&
	...
	if($objConnect){
		if(strtolower($STATUS) == "open"){
			...
			$SQL2 = "insert into fttx_workorder_prom_test (REF_NO,PROJECTNAME,STATUS,REGION,WORK_NO,CONTRACTORNAME,LOCATION,DESCRIPTION,CREATE_BY,CREATE_DATE,SOS,SOS_SITENAME) values 
